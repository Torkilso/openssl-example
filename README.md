# Example C++ Application using OpenSSL [![Build Status](https://travis-ci.org/Torkilso/openssl-example.svg?branch=master)](https://travis-ci.org/ntnu-tdat3020/openssl-example)
